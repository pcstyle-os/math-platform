...
Apply common refactoring patterns (Extract Method, Rename, Move, Inline).

## Instructions

- **Extract Method**: If a function is too long, move a logic block into a new function with a descriptive name.
